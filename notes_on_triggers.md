...
Plug in the USB cable connected to the EEG or TMS systems.
...
This code might list all the COM ports on your machine, try it out and see if you can find the one corresponding to your device:
